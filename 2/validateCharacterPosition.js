module.exports = (policyAndPassword) => {
    ...
    return (passwordPieces[characterPositions[0] - 1] === character && passwordPieces[characterPositions[1] - 1] !== character) || 
        (passwordPieces[characterPositions[1] - 1] === character && passwordPieces[characterPositions[0] - 1] !== character);
}